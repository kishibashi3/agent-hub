...
- [decisions/2026-06-06-bridge-memory-interface.md](./decisions/2026-06-06-bridge-memory-interface.md) — ADR-007: Bridge Memory Interface — context persistence across sessions (scope: ecosystem, Proposed)
